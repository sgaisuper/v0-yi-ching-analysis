          ...
          <footer className="border-t border-border py-8">
            <div className="mx-auto max-w-2xl px-6 text-center">
              <p className="text-xs text-muted-foreground font-sans">
                The Yi Ching (I Ching), or Book of Changes, is an ancient
                Chinese divination text dating back over 3,000 years. These
                readings are for contemplation and personal reflection.
              </p>
            </div>
          </footer>
        </div>
